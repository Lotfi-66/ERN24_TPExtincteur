 ...
 */
final class Version20240731073250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE extincteur (id INT AUTO_INCREMENT NOT NULL, date_fabrication DATE NOT NULL, date_maintenance DATE NOT NULL, is_active TINYINT(1) NOT NULL, quantity VARCHAR(255) NOT NULL, extincteur_type_id_id INT DEFAULT NULL, INDEX IDX_36590C7C3419BCA (extincteur_type_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE rapport (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, user_id INT DEFAULT NULL, intervention_id INT DEFAULT NULL, status_id INT DEFAULT NULL, INDEX IDX_BE34A09CA76ED395 (user_id), UNIQUE INDEX UNIQ_BE34A09C8EAE3863 (intervention_id), INDEX IDX_BE34A09C6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
